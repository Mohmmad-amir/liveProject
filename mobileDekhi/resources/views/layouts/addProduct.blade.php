                        ...
                        <div class="row">
                            ...
                            <div class="col-3 col-sm-3 col-md-3">
                                <div class="form-group">
                                    ...
                                    <input id="image" name="imagetwo" type="file" accept="image/*" class="form-control"
                                        aria-describedby="textHelp">
                                </div>
                            </div>
                            ...
                            <div class="col-3 col-sm-3 col-md-3">
                                <div class="form-group">
                                    ...
                                    <input id="image" name="imagethree" type="file" accept="image/*" class="form-control"
                                        aria-describedby="textHelp">
                                </div>
                            </div>
                            <div class="col-3 col-sm-3 col-md-3">
                                <div class="form-group">
                                    ...
                                    <input id="image" name="imagefour" type="file" accept="image/*" class="form-control"
                                        aria-describedby="textHelp">
                                </div>
                            </div>
