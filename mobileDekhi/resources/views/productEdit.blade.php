                        ...
                        <div class="row">
                            ...
                            <div class="col-4 col-sm-4 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="product_name" value="{{ $products->name }}" type="text" id="ProductName"
                            ...
                            <div class="col-4 col-sm-4 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $products->body_color }}" name="BodyColor" id="BodyColor"
                                        class="form-control" aria-describedby="textHelp">
                                </div>
                            </div>
                            ...
                            <div class="col-4 col-sm-4 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="bodyDimensions" value="{{ $products->body_dimensions }}"
                                        id="bodyDimensions" type="text" class="form-control" aria-describedby="textHelp">
                                </div>
                            </div>
                            <div class="col-4 col-sm-4 col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-4 col-sm-4 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="displayResolution" value="{{ $products->display_resolution }}"
                                        id="displayResolution" type="text" class="form-control" aria-describedby="textHelp">
                                </div>
                            </div>
                            ...
                            <div class="col-4 col-sm-4 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="displayMultitouch" value="{{ $products->display_multi_touch }}"
                                        id="displayMultitouch" type="text" class="form-control" aria-describedby="textHelp">
                                </div>
                            </div>
                            ...
                            <div class="col-4 col-sm-4 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="DisplayDensity" value="{{ $products->display_density }}"
                                        id="DisplayDensity" type="text" class="form-control" aria-describedby="textHelp">
                                </div>
                            </div>
                            ...
                            <div class="col-4 col-sm-4 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="OperatingSystem" value="{{ $products->operating_system }}"
                                        id="OperatingSystem" type="text" class="form-control" aria-describedby="textHelp">
                                </div>
                            </div>
                            <div class="col-4 col-sm-4 col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-4 col-sm-4 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="MemoryInternal" value="{{ $products->memory_internal }}"
                                        id="MemoryInternal" type="text" class="form-control" aria-describedby="textHelp">
                                </div>
                            </div>
                            <div class="col-4 col-sm-4 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="MemoryExternal" value="{{ $products->memory_external }}"
                                        id="MemoryExternal" type="text" class="form-control" aria-describedby="textHelp">
                                </div>
                            </div>
                            <div class="col-4 col-sm-4 col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-4 col-sm-4 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $products->secondary_camera }}" name="SecondaryCamera"
                                        id="SecondaryCamera" class="form-control" aria-describedby="textHelp">
                                </div>
                            </div>
                            <div class="col-4 col-sm-4 col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-4 col-sm-4 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $products->bluetooth }}" name="Bluetooth" id="Bluetooth"
                                        class="form-control" aria-describedby="textHelp">
                                </div>
                            </div>
                            <div class="col-4 col-sm-4 col-md-4">
                            ...
                            <div class="col-4 col-sm-4 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $products->battery_capacity }}" name="BatteryCapacity"
                                        id="BatteryCapacity" class="form-control" aria-describedby="textHelp">
                                </div>
                            </div>
                            <div class="col-4 col-sm-4 col-md-4">
                                <div class="form-group">
                                    <label for="Charging">Charging</label>
                                    <input type="text" value="{{ $products->charging }}" name="Charging" id="Charging"
                                        class="form-control" aria-describedby="textHelp">
                                </div>
                            </div>
