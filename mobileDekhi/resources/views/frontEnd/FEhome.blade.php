        ...
        <div class="row">
            ...
            <div class="col-4 col-sm-4 col-md-3  mt-2" data-aos="fade-up" data-aos-offset="5" data-aos-delay="50" data-aos-duration="100">
                <div class="card w-100 shadow-sm">
                    <img style="height: 250px; width: 30px; padding-top: 30px; padding-left: 30px; padding-right: 30px;" src="{{asset('assets/img')}}/{{$product->image}}" class="card-img-top card-image w-100 img-fluid mt-2" alt="...">
